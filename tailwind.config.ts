	...
	theme: {
		...
		extend: {
			colors: {
				...
				// Copiloto Niawi custom colors - Now theme-aware!
				niawi: {
			...
			keyframes: {
				...
				'glow-pulse': {
					'0%, 100%': {
						boxShadow: '0 0 10px rgba(37, 99, 235, 0.2), 0 0 20px rgba(37, 99, 235, 0.1)'
					},
					'50%': {
						boxShadow: '0 0 20px rgba(37, 99, 235, 0.4), 0 0 40px rgba(77, 212, 255, 0.2)'
					}
				},
				'float-subtle': {
					'0%, 100%': {
